...
# Destructive action
delete_btn = LimButton("Delete Item")
...
# Muted text
subtitle = LimLabel("Statistics for the last 30 days")
...
layout.addWidget(LimButton("Card Action"))`
    },
    "LimSwitch": {
        title: "LimSwitch",
...
toggle.toggled.connect(lambda c: print("State:", c))`
    ...
    "LimInput": {
        title: "LimInput",
        description: "A styled compiled meant for single-line text input. It features clear focus states and placeholder text support.",
